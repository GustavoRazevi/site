...
const oleoObras = [
  {
    thumb: "../img/oleo/ABRAZANDO EL UNIVERSO.jpg",
    full: "../img/oleo/ABRAZANDO EL UNIVERSO.jpg",
    alt: "Abrazo el Universo, óleo sobre lienzo",
  ...
  {
    thumb: "../img/oleo/ALTER-EGO.jpg",
    full: "../img/oleo/ALTER-EGO.jpg",
    alt: "Alter Ego, óleo sobre lienzo",
    titulo: "Alter Ego",
  ...
  {
    thumb: "../img/oleo/DENORTEASUR.jpg",
    full: "../img/oleo/DENORTEASUR.jpg",
    alt: "De Norte a Sur, óleo sobre lienzo",
