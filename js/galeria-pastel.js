...
const oleoObras = [
  {
    thumb: "../img/pastel/CANDY.jpg",
    full: "../img/pastel/CANDY.jpg",
    alt: "Candy, pastel sobre algodón",
    titulo: "Candy",
    ...
    {
    thumb: "../img/pastel/CHARLY.jpg",
    full: "../img/pastel/CHARLY.jpg",
    alt: "Charly, pastel sobre papel",
    titulo: "Charly",   
    tecnica: "Pastel sobre algodón",
    dimensiones: "37 x 30 cm",
    anio: "2023",
